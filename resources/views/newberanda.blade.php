    ...
    <body id="page-top">
        ...
        {{-- <div class="site-section" id="about-section">
            <div class="container"> --}}
                ...
                <div class="col-lg-4">
                  <img src="{{asset('img/ptindopara.png')}}" alt="Image" class="img-fluid" width="500px">
                </div>
                <div class="col-lg-4">
...
<!--End Service-->
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="p-5"><img class="img-fluid rounded-circle" src="new/img/01.jpg" alt="..." /></div>
                    </div>
        ...
        <section>
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="p-5"><img class="img-fluid rounded-circle" src="new/img/02.jpg" alt="..." /></div>
                    </div>
                    <div class="col-lg-6">
                        <div class="p-5">
        ...
        <section>
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="p-5"><img class="img-fluid rounded-circle" src="new/img/03.jpg" alt="..." /></div>
                    </div>
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
...
<section class="page-section bg-light" id="team">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">PT. Indopara Sista Semesta</h3>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">VISI MISI ??</p></div>
                </div>
            </div>
        </section>
        <!-- Clients
