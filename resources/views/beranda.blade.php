...
<html lang="en">
    <head>
        ...
        <meta nae="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
    ...
    <body>
        ...
        {{-- <nav class="navbar navbar-light bg-light static-top">
            <div class="container">
                ...
                <a class="navbar-brand" href="#!">PT INDOPARA </a>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="text-center">
                            <!-- Page heading-->
                            <h1 class="mb-5">PT INDO PARA SISTA SEMESTA</h1>
                            <h2 class="mb-3">MILITARY EQUIPMENT</h2>
                            <!-- Signup form-->
                            <!-- * * * * * * * * * * * * * * *-->
